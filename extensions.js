...
export const FormExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    formContainer.innerHTML = `
          ...
          <input type="text" class="lname" name="lname" required><br><br>
          ...
          <div class="phone-container">
            ...
            <input 
              ...
              title="Please enter a 10-digit US phone number without spaces, dashes, or parentheses">
          </div>
          <br><br>
    ...
    formContainer.addEventListener('submit', function (event) {
      ...
      const firstname = formContainer.querySelector('.fname')
      const lastname = formContainer.querySelector('.lname')
      ...
      window.voiceflow.chat.interact({
        ...
        payload: { 
          ...
          email: email.value, 
          phone: '+1' + phone.value.replace(/\D/g, ''), // Remove non-digits and add +1
